...
export const courses: Course[] = [
    {
        ...
        units: [
            ...
            { id: "unit06-lesson12", title: "第12次课：会员画像与HBase进阶查询", available: false },
            { id: "unit07-lesson13", title: "第13次课：Zookeeper集群部署与分布式协调", available: false },
            { id: "unit08-lesson14", title: "第14次课：HDFS高可用与双11宕机模拟", available: false },
            { id: "unit08-lesson15", title: "第15次课：综合项目启动与架构设计", available: false },
            { id: "unit08-lesson16", title: "第16次课：数仓建模与经营分析大屏", available: false },
        ],
    },
    {
        id: "25-2-javaweb",
