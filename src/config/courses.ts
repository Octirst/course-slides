...
export const courses: Course[] = [
    {
        ...
        units: [
            ...
            { id: "unit03-lesson06", title: "第6次课：Hive安装与零售数仓初建", available: true },
            { id: "unit03-lesson07", title: "第7次课：HiveSQL单表查询与分析", available: true },
            { id: "unit04-lesson08", title: "第8次课：多表关联与运维操作", available: false },
            { id: "unit04-lesson09", title: "第9次课：Flume架构与基础采集配置", available: false },
            { id: "unit04-lesson10", title: "第10次课：Flume采集至HDFS与多门店汇聚", available: false },
            { id: "unit05-lesson11", title: "第11次课：HBase安装与NoSQL快速查询", available: false },
            { id: "unit05-lesson12", title: "第12次课：会员画像与HBase进阶查询", available: false },
            { id: "unit06-lesson13", title: "第13次课：Zookeeper集群部署与分布式协调", available: false },
            { id: "unit06-lesson14", title: "第14次课：HDFS高可用与双11宕机模拟", available: false },
            { id: "unit07-lesson15", title: "第15次课：综合项目启动与架构设计", available: false },
            { id: "unit07-lesson16", title: "第16次课：数仓建模与经营分析大屏", available: false },
        ],
    },
    {
        id: "25-2-javaweb",
