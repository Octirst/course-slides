import{o as e}from"./slidev/Mermaid-BE8QpgW9.js";import{r as t}from"./chunk-PTVI3W5X-pc1cHuci.js";import{M as n,N as r,T as i,n as a}from"./chunk-V7P66DNM-QgGKa9Wy.js";import{C as o,E as s,J as c,Q as l,Y as u,b as d,l as f,m as p,o as m,x as h}from"./chunk-Q52JI7PB-ql4vI9m0.js";import"./chunk-7TFACZ55-B-jCthQ9.js";import{h as g,i as _}from"./chunk-BSZA5ISF-CpoNvHXe.js";import{y as v}from"./chunk-BBDM4ZFP-DCglo5JJ.js";import{t as y}from"./chunk-6ZKBGPIT-Dru5q8HC.js";var b=p.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:t(()=>structuredClone(w),`getConfig`),clear:t(()=>{S=new Map,C=x.showData,m()},`clear`),setDiagramTitle:l,getDiagramTitle:s,setAccTitle:u,getAccTitle:h,setAccDescription:c,getAccDescription:d,addSection:t(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),i.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:t(()=>S,`getSections`),setShowData:t(e=>{C=e},`setShowData`),getShowData:t(()=>C,`getShowData`)},E=t((e,t)=>{y(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:t(async e=>{let t=await v(`pie`,e);i.debug(t),E(t,T)},`parse`)},O=t(e=>`
  .pieCircle{
