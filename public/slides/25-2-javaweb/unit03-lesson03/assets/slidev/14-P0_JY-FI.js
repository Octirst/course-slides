import{I as _}from"./default-CW1G3Tbs.js";import{b,T as a}from"../index-Cgos5yGj.js";import{p as c,u as x,f as w}from"./context-BJ_dCp7m.js";import{at as k,o as l,b as j,w as P,g as e,j as S,a5 as v,e as p,a0 as m,v as $,x as y}from"../modules/vue-CffDVSch.js";import"../modules/shiki-CnOhAU2b.js";const C={__name:"14",setup(u,{expose:t}){t(),c(a);const{$slidev:r,$nav:s,$clicksContext:d,$clicks:i,$page:n,$renderContext:f,$frontmatter:g}=x(),o={$slidev:r,$nav:s,$clicksContext:d,$clicks:i,$page:n,$renderContext:f,$frontmatter:g,InjectedLayout:_,get frontmatter(){return a},get useSlideContext(){return x},get _provideFrontmatter(){return c},get _frontmatterToProps(){return w}};return Object.defineProperty(o,"__isScriptSetup",{enumerable:!1,value:!0}),o}},T={class:"flex justify-center mt-6"},B={class:"flex flex-col items-center"},D={class:"flex items-center gap-2"},I={class:"mt-6 text-center p-3 bg-yellow-500/20 rounded-lg"};function J(u,t,r,s,d,i){const n=k("click");return l(),j(s.InjectedLayout,$(y(s._frontmatterToProps(s.frontmatter,13))),{default:P(()=>[t[3]||(t[3]=e("h1",null,"🔄 JSP 完整生命周期",-1)),e("div",T,[e("div",B,[S(" 第一阶段：翻译 "),v((l(),p("div",D,[...t[0]||(t[0]=[e("div",{class:"bg-blue-500/30 p-4 rounded-lg text-center w-28"},[e("div",{class:"text-2xl"},"📝"),e("p",{class:"font-bold text-sm"},"翻译"),e("p",{class:"text-xs"},".jsp → .java")],-1),e("div",{class:"text-xl"},"➡️",-1),e("div",{class:"bg-blue-500/20 p-3 rounded text-xs w-32"}," JSP容器解析标签 ",-1)])])),[[n,1]]),t[1]||(t[1]=e("pre",null,[e("code",null,`<!-- 第二阶段：编译 -->
...
`)],-1))])]),v((l(),p("div",I,[...t[2]||(t[2]=[e("p",null,[m("🎯 "),e("strong",null,"思政点"),m("：基础打得牢（预处理），后续运行才高效！")],-1)])])),[[n,6]])]),_:1},16)}const E=b(C,[["render",J],["__file","/@slidev/slides/14.md"]]);export{E as default};
