import{o as n,b as d,w as l,g as t,j as u,ad as r,v as p,x as m,T as s}from"./modules/vue-AeBPv1kZ.js";import{I as c}from"./slidev/default-LjZmWgc2.js";import{u as i,f}from"./slidev/context-BJyZS9-b.js";import"./index-D5sudkc2.js";import"./modules/shiki-CrQWOT2k.js";const b={__name:"slides.md__slidev_28",setup(v){const{$clicksContext:e,$frontmatter:a}=i();return e.setup(),(x,o)=>(n(),d(c,p(m(s(f)(s(a),27))),{default:l(()=>[o[0]||(o[0]=t("h1",null,"📝 商品列表JSP代码",-1)),u(" demo06_product_list.jsp "),o[1]||(o[1]=t("div",{class:"bg-gray-800 text-gray-100 p-3 rounded-lg font-mono text-sm mt-4"},[t("pre",null,`<c:forEach var="product" items="\${productList}" varStatus="vs">
  <tr>
    <td>\${vs.count}</td>
    <td>\${product.name}</td>
